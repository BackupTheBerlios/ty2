...
public class MapPanel extends Panel {
  ...
  public boolean cursor=false;
    ...
    addMouseListener(new MouseAdapter() {
        ...
        int x=e.getX()/TILEWIDTH+scrollx;
				int y=e.getY()/TILEHEIGHT+scrolly;
				...
				if (dir==1) {
				  ...
				  doExplosion(x,y,RPG.r(3),5,RPG.DT_NORMAL);	
				}  
			} */
  ...
  public void drawTiles(int x1, int y1, int x2, int y2) {
	  //do LOS calculations	  
	  map.calcVisible(Game.hero.x,Game.hero.y,map.visibleRange());
