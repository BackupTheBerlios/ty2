...
public class Potion extends Stack implements Description {
	...
	private static boolean potionKnown[] = new boolean[15];
	...
	public static Stack createPotion(int i) {
		return new Potion(potions[i]); 
	}
	...
	public boolean isIdentified() {
		...
		if(b){
			...
			return getPotionKnown(type);
		}
	}
	
	public void setPotionKnown( int i ){
		potionKnown[i] = true;
	}

	public boolean getPotionKnown( int i ){
		return potionKnown[i];
	}
}