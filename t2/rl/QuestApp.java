...
public class QuestApp extends Applet implements Runnable {
  ...
  public static final Color textcolor=new Color(192,192,192);
  public static final Color backcolor=new Color(0,0,0);
  ...
  public static final Color infoscreencolor=new Color(0,0,0);
  public static final Color infotextcolor=new Color(192,192,192);
...
//  public static final Color panelshadow=new Color(80,32,16);
  ...
  private static final String[] herostrings={"fighter","fighter-mage","sorceror","runecaster","priest","bard","warrior-priest","barbarian","ranger","enchanter","thief"};
  private static final String[] raceherostrings={"human","hobbit","dwarf","high elf","wood elf","dark elf","gnome","orc","goblin","troll"};
  private static final String[] debugherostrings={"fighter","fighter-mage","sorceror","runecaster","priest","bard","warrior-priest","barbarian","ranger","enchanter","avatar"};
  ...
  public void gameOver() {
    ...
    } catch (Exception e) {hresult="High score feature not available";}
